...
public class Science_Book extends Book {
  ...
  public Science_Book(String code,String publisher,String title, Vector authors,String subject) {
    ...
    for (int i=0;i<18;i++)
      MembershipToClasses[i] = Database.Minimum(Object_Class_Membership_Degree, Database.Similarity_Matrix_for_Classes[8][i]);
  }

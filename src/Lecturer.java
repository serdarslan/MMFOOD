...
public class Lecturer extends Member {
  String Education;
  static String[] Fuzzy_Terms_Education_Range = {"phd"};

  public Lecturer(int member_id,String name_surname,int max_borrowing, Vector books,String education) {
    ...
    for (int i=0;i<18;i++)
      MembershipToClasses[i] = Database.Minimum(Object_Class_Membership_Degree , Database.Similarity_Matrix_for_Classes[4][i]);
  }

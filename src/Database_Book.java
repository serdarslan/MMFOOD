...
public class Database_Book extends Book {
  String Subject;
  static String[] Fuzzy_Terms_Subject_Range = {"algorithms","data Sstructures","database"};

  public Database_Book(String code,String publisher,String title, Vector authors,String subject) {
    ...
    for (int i=0;i<18;i++)
      MembershipToClasses[i] = Database.Minimum(Object_Class_Membership_Degree, Database.Similarity_Matrix_for_Classes[14][i]);
  }

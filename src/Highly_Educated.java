...
public class Highly_Educated extends Member {
  String Education;
  static String[] Fuzzy_Terms_Education_Range = {"phd","ms"};

  public Highly_Educated(int member_id,String name_surname,int max_borrowing, Vector books,String education) {
    ...
    for (int i=0;i<18;i++)
      MembershipToClasses[i] = Database.Minimum(Object_Class_Membership_Degree , Database.Similarity_Matrix_for_Classes[2][i]);
  }
